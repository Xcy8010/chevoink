...
export default function AdminModelsPage() {
  ...
  const mutation = useMutation({
    mutationFn: () => editing
      ? updateAdminModel(editing.id, { ...form, baseUrl: form.baseUrl || null, apiKey: form.apiKey || undefined, multiplier: Number(form.multiplier), contextWindowTokens: editing.modelKind === 'text' ? Number(form.contextWindowTokens) : undefined })
