import { FilePlus2, FolderPlus, MessageSquarePlus, X } from 'lucide-react'
...
export default function StudioChapterViewer({ draft, workspaceDocument = null, loading, selection, onChange, onWorkspaceDocumentChange, onSelectionChange, onAddSelection, onCreateVolume, onCreateChapter, onClose, onBlur }: Props) {
