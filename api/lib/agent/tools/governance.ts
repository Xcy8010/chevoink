...
export const AGENT_TOOL_GOVERNANCE = {
  ...
  subagent_delegate: { category: 'workflow', risk: 'medium', postconditions: ['explicit_name_recorded', 'parent_scope_verified', 'inline_execution_only', 'definition_deduped_by_name'] },
  subagent_run: { category: 'workflow', risk: 'medium', postconditions: ['definition_enabled_verified', 'parent_scope_verified', 'inline_execution_only', 'report_reviewed_by_orchestrator'] },
  ...
  skill_install_shared: { category: 'workflow', risk: 'medium', postconditions: ['explicit_confirmation', 'pending_invite_verified', 'next_turn_effect'] },
  ...
  quality_analyze: { category: 'write', risk: 'medium', postconditions: ['writer_context_isolated', 'deterministic_signals_preserved', 'exact_evidence_located', 'single_critic_pass', 'bounded_auto_repair', 'chapter_revision_advanced_or_unchanged'] },
